Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/good-doctor-technology/RxComposableArchitecture"
  spec.authors      = { "98prabowo" => "dimasprabowo98@icloud.com" }
  spec.source       = { :git => "https://github.com/good-doctor-technology/RxComposableArchitecture.git", :tag => "#{spec.version}" }
